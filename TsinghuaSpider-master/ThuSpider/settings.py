# Django settings for ThuSpider project.
import os
...
SECRET_KEY = '6w*9r+cj!^tyv$!1w@a&hj%od2o1yajbodhs@4odjtk^ydd16*'
...
ROOT_URLCONF = 'ThuSpider.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ThuSpider.wsgi.application'
